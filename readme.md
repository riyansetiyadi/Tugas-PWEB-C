...
🌐 **URL Web:** https://riyansetiyadi.github.io/Tugas-PWEB-C/
...
4. pastikan ketika form disubmit tidak mereload halaman kalian, pelajari function (preventDefault) untuk menghentikan default action dari elemen-elemen html

5. terakhir, ganti warna web kalian menjadi hijau jika login berhasil

Syarat Pengumpulan :
- kumpulkan berupa github.io yang bisa diakses, di github masing-masing (penilaian individu)
